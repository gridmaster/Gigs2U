...
if(isset($_POST['post_message'])) {
 ...
 <div class="user_details column">
	...
	<div class="main_column column" id="main_column">
		<?php  
		if($user_to_ID != "new"){
			echo "<h4>You and <a href='$user_to_ID'>" . $user_to_obj->getFirstAndLastName() . "</a></h4><hr><br>";
		...
		<div class="message_post">
			<form action="" method="POST">
				...
				if($user_to_ID == "new") {
					...
					?> 
					To: <input type='text' onkeyup='getUsers(this.value, "<?php echo $userLoggedInID; ?>")' name='q' placeholder='Name' autocomplete='off' id='seach_text_input'>
