...
<body>
	...
	$user_query = mysqli_query($con, "SELECT added_by_ID, user_to_ID FROM posts WHERE id='$post_id'");
	$row = mysqli_fetch_array($user_query);

	$posted_to_ID = $row['added_by_ID'];
	...
	if($count != 0) {
		...
		while($comment = mysqli_fetch_array($get_comments)) {
			...
			<div class="comment_section">
				<a href="<?php echo $posted_by_ID?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic();?>" title="<?php echo $posted_by_ID; ?>" style="float:left;" height="30"></a>
				<a href="<?php echo $posted_by_ID?>" target="_parent"> <b> <?php echo $user_obj->getFirstAndLastName(); ?> </b></a>
